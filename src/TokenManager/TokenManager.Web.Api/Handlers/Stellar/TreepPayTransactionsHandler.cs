...
namespace TokenManager.Web.Api.Handlers.Stellar
{
    public class TreepPayTransactionsHandler : QueuedHandler
    {
        private readonly StellarBlockchainService _stellarBlockchainService;

        public TreepPayTransactionsHandler(ILogger<QueuedHandler> logger, StellarBlockchainService stellarBlockchainService) : base(logger)
        {
        ...
        public override async Task DoWork()
        {
            ...
            {
                var query = "SELECT TOP 25 * FROM TreepPayTransactions";
