...
{
    public class StellarPaymentsHandler : QueuedHandler
    {
        private readonly StellarBlockchainService _stellarBlockchainService;

        public StellarPaymentsHandler(ILogger<QueuedHandler> logger, StellarBlockchainService stellarBlockchainService) : base(logger)
        {
        ...
        public override async Task DoWork()
        {
            ...
            {
                var query = "SELECT TOP 25 * FROM QuitacaoClubeVantagens";
